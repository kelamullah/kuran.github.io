...
Not: Bu komutlar için Node.js 20.19+ gereklidir.

Not (ESLint 10): `eslint-plugin-react-hooks` paketi ESLint 10 desteği için canary sürümünde kullanılmaktadır. Bu nedenle `npm outdated` çıktısında hooks paketi stable sürüme göre geride görünebilir; bu bilinçli bir tercihtir.
